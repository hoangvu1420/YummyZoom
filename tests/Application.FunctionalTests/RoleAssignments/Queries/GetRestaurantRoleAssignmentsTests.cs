...
public class GetRestaurantRoleAssignmentsTests : BaseTestFixture
{
    ...
    public async Task SetUp()
    {
        ...
        _userId1 = await RunAsUserAsync("user5@example.com", "Password123!", new[] { Roles.Administrator });
        _userId2 = await RunAsUserAsync("user6@example.com", "Password123!", new[] { Roles.Administrator });
