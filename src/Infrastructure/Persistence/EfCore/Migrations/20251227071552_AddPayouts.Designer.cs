...
namespace YummyZoom.Infrastructure.Persistence.EfCore.Migrations
{
    ...
    [Migration("20251227071552_AddPayouts")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YummyZoom.Domain.PayoutAggregate.Payout", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Created")
                        .HasDatabaseName("IX_Payout_Created");
            ...
            modelBuilder.Entity("YummyZoom.Domain.RestaurantRegistrationAggregate.RestaurantRegistration", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Status")
                        .HasDatabaseName("IX_RestaurantRegistrations_Status");

                    b.HasIndex("SubmittedAtUtc")
                        .HasDatabaseName("IX_RestaurantRegistrations_SubmittedAtUtc");

                    b.HasIndex("SubmitterUserId", "Name", "City")
                        .HasDatabaseName("IX_RestaurantRegistrations_Submitter_Name_City");
            ...
            modelBuilder.Entity("YummyZoom.Domain.TeamCartAggregate.TeamCart", b =>
                {
                    ...
                    b.Property<string>("MemberTotalsRows")
                        .IsRequired()
                        .HasColumnType("jsonb")
                        .HasColumnName("MemberTotals");

                    b.Property<long>("QuoteVersion")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("YummyZoom.Infrastructure.Persistence.EfCore.Models.CouponUserUsage", b =>
                {
            ...
            modelBuilder.Entity("YummyZoom.Infrastructure.Persistence.EfCore.Models.InboxMessage", b =>
                {
            ...
            modelBuilder.Entity("YummyZoom.Infrastructure.Persistence.EfCore.Models.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("YummyZoom.Infrastructure.Persistence.ReadModels.Admin.AdminDailyPerformanceSeries", b =>
                {
                    ...
                    b.Property<decimal>("GrossMerchandiseVolume")
                        .HasColumnType("decimal(18,2)");

                    b.Property<int>("NewCustomers")
                        .HasColumnType("integer");

                    b.Property<int>("NewRestaurants")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("AdminDailyPerformanceSeries", (string)null);
                });

            modelBuilder.Entity("YummyZoom.Infrastructure.Persistence.ReadModels.Admin.AdminPlatformMetricsSnapshot", b =>
                {
                    ...
                    b.Property<long>("ActiveOrders")
                        .HasColumnType("bigint");

                    b.Property<int>("ActiveRestaurants")
                        .HasColumnType("integer");

                    b.Property<long>("DeliveredOrders")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("AdminPlatformMetricsSnapshots", (string)null);
                });

            modelBuilder.Entity("YummyZoom.Infrastructure.Persistence.ReadModels.Admin.AdminRestaurantHealthSummary", b =>
                {
                    b.Property<Guid>("RestaurantId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("CouponRedemptionsLast30Days")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("AdminRestaurantHealthSummaries", (string)null);
                });

            modelBuilder.Entity("YummyZoom.Infrastructure.Persistence.ReadModels.Coupons.ActiveCouponView", b =>
                {
                    b.Property<Guid>("CouponId")
                        .HasColumnType("uuid")
                        .HasColumnName("coupon_id");

                    b.Property<string>("AppliesToCategoryIds")
                        .HasColumnType("text")
                        .HasColumnName("applies_to_category_ids");

                    b.Property<string>("AppliesToItemIds")
                        .HasColumnType("text")
                        .HasColumnName("applies_to_item_ids");
                    ...
                    b.Property<int>("CurrentTotalUsageCount")
                        .HasColumnType("integer")
                        .HasColumnName("current_total_usage_count");
                    ...
                    b.Property<string>("MinOrderCurrency")
                        .HasColumnType("text")
                    ...
                    b.ToView("active_coupons_view", (string)null);
                });

            modelBuilder.Entity("YummyZoom.Infrastructure.Persistence.ReadModels.FullMenu.FullMenuView", b =>
                {
                    b.Property<Guid>("RestaurantId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<DateTimeOffset>("LastRebuiltAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("LastRebuiltAt")
                        .HasDatabaseName("IX_FullMenuViews_LastRebuiltAt");

                    b.ToTable("FullMenuViews", (string)null);
                });

            modelBuilder.Entity("YummyZoom.Infrastructure.Persistence.ReadModels.MenuItemSales.MenuItemSalesSummary", b =>
                {
                    b.Property<Guid>("RestaurantId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<long>("LifetimeQuantity")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasDefaultValue(0L);

                    b.Property<long>("Rolling30DayQuantity")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasDefaultValue(0L);

                    b.Property<long>("Rolling7DayQuantity")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasDefaultValue(0L);
                    ...
                    b.HasKey("RestaurantId", "MenuItemId");
                    ...
                    b.ToTable("MenuItemSalesSummaries", (string)null);
                });

            modelBuilder.Entity("YummyZoom.Infrastructure.Persistence.ReadModels.Reviews.RestaurantReviewSummary", b =>
                {
                    b.Property<Guid>("RestaurantId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("Ratings1")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);

                    b.Property<int>("Ratings2")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);

                    b.Property<int>("Ratings3")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);

                    b.Property<int>("Ratings4")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);

                    b.Property<int>("Ratings5")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);
            ...
            modelBuilder.Entity("YummyZoom.Infrastructure.Persistence.ReadModels.Search.SearchIndexItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Cuisine")
                        .HasDatabaseName("SIDX_Trgm_Cuisine");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("Cuisine"), "GIN");
                    NpgsqlIndexBuilderExtensions.HasOperators(b.HasIndex("Cuisine"), new[] { "gin_trgm_ops" });

                    b.HasIndex("Geo")
                        .HasDatabaseName("SIDX_Geo");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("Geo"), "GIST");

                    b.HasIndex("Name")
                        .HasDatabaseName("SIDX_Trgm_Name");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("Name"), "GIN");
                    NpgsqlIndexBuilderExtensions.HasOperators(b.HasIndex("Name"), new[] { "gin_trgm_ops" });

                    b.HasIndex("PriceBand")
                        .HasDatabaseName("SIDX_PriceBand");

                    b.HasIndex("SoftDeleted")
                        .HasDatabaseName("SIDX_Soft_Deleted");

                    b.HasIndex("Tags")
                        .HasDatabaseName("SIDX_Tags_Gin");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("Tags"), "GIN");

                    b.HasIndex("TsAll")
                        .HasDatabaseName("SIDX_Tsv_All");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("TsAll"), "GIN");

                    b.HasIndex("TsDescr")
                        .HasDatabaseName("SIDX_Tsv_Descr");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("TsDescr"), "GIN");

                    b.HasIndex("TsName")
                        .HasDatabaseName("SIDX_Tsv_Name");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("TsName"), "GIN");

                    b.HasIndex("UpdatedAt")
                        .HasDatabaseName("SIDX_Updated_At");

                    b.HasIndex("Type", "IsOpenNow", "IsAcceptingOrders")
                        .HasDatabaseName("SIDX_Type_Open");

                    b.ToTable("SearchIndexItems", (string)null);
                });
            ...
            modelBuilder.Entity("YummyZoom.Domain.RestaurantAccountAggregate.RestaurantAccount", b =>
                {
                    ...
                    b.OwnsOne("YummyZoom.Domain.Common.ValueObjects.Money", "PendingPayoutTotal", b1 =>
                        {
                            b1.Property<Guid>("RestaurantAccountId")
                                .HasColumnType("uuid");
                    ...
                    b.Navigation("PendingPayoutTotal")
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("YummyZoom.Domain.RestaurantAggregate.Restaurant", b =>
                {
                    ...
                    b.OwnsOne("YummyZoom.Domain.RestaurantAggregate.ValueObjects.GeoCoordinates", "GeoCoordinates", b1 =>
                        {
                            b1.Property<Guid>("RestaurantId")
                                .HasColumnType("uuid");
            ...
            modelBuilder.Entity("YummyZoom.Domain.TeamCartAggregate.TeamCart", b =>
                {
                    ...
                    b.OwnsOne("YummyZoom.Domain.Common.ValueObjects.Money", "GrandTotal", b1 =>
                        {
                            b1.Property<Guid>("TeamCartId")
                                .HasColumnType("uuid");
