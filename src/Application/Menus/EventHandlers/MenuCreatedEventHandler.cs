...
/// <summary>
/// Handles MenuCreated domain events by rebuilding the FullMenuView for the affected restaurant.
/// Strategy: naive, correct-first full rebuild per restaurant.
/// Idempotent via inbox infrastructure.
/// </summary>
public sealed class MenuCreatedEventHandler : IdempotentNotificationHandler<MenuCreated>
{
    ...
    protected override async Task HandleCore(MenuCreated notification, CancellationToken ct)
    {
        _logger.LogInformation("Handling MenuCreated (EventId={EventId}, MenuId={MenuId}, RestaurantId={RestaurantId})",
