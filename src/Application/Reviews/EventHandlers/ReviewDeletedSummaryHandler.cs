...
public sealed class ReviewDeletedSummaryHandler : IdempotentNotificationHandler<ReviewDeleted>
{
    ...
    public ReviewDeletedSummaryHandler(IUnitOfWork uow, IInboxStore inbox, IReviewSummaryMaintainer maintainer, ISearchReadModelMaintainer searchMaintainer, IDbConnectionFactory db)
        : base(uow, inbox)
    {
    ...
    protected override async Task HandleCore(ReviewDeleted e, CancellationToken ct)
    {
