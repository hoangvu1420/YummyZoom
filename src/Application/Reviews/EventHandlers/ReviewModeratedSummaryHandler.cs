...
public sealed class ReviewModeratedSummaryHandler : IdempotentNotificationHandler<ReviewModerated>
{
    ...
    public ReviewModeratedSummaryHandler(IUnitOfWork uow, IInboxStore inbox, IReviewSummaryMaintainer maintainer, ISearchReadModelMaintainer searchMaintainer, IDbConnectionFactory db)
        : base(uow, inbox)
    {
    ...
    protected override async Task HandleCore(ReviewModerated e, CancellationToken ct)
    {
