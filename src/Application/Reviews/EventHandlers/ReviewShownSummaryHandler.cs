...
public sealed class ReviewShownSummaryHandler : IdempotentNotificationHandler<ReviewShown>
{
    ...
    public ReviewShownSummaryHandler(IUnitOfWork uow, IInboxStore inbox, IReviewSummaryMaintainer maintainer, ISearchReadModelMaintainer searchMaintainer, IDbConnectionFactory db)
        : base(uow, inbox)
    {
    ...
    protected override async Task HandleCore(ReviewShown e, CancellationToken ct)
    {
