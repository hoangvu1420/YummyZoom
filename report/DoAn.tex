...
\usepackage{fix-cm} % Cho phép sử dụng Computer Modern fonts ở mọi kích thước
\usepackage{type1cm} % Cho phép scaling fonts

% Thiết lập kích thước font 13pt một cách an toàn
...
\counterwithin{table}{chapter}  % Đánh số bảng biểu kèm theo chapter. Ví dụ: Bảng 2.1, 2.2,..
...
\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{GIẢI PHÁP ĐÓNG GÓP, KẾT LUẬN VÀ HƯỚNG PHÁT TRIỂN}
\label{chapter:SolutionConclusionAndFutureWork}
