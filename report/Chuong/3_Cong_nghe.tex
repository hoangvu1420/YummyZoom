...
Bên cạnh kết nối thời gian thực bằng SignalR, hệ thống tích hợp dịch vụ \textbf{Firebase Cloud Messaging (FCM)} để giải quyết bài toán gửi thông báo đến người dùng ngay cả khi ứng dụng đang chạy nền (Background) hoặc đã tắt hoàn toàn.
