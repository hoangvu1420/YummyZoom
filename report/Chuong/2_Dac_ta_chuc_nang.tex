...
\begin{table}[H]
    \centering
    \begin{tabular}{|p{2.5cm}|p{1.5cm}|p{3cm}|p{5.5cm}|}
        \hline
    ...
    \end{tabular}
    \caption{Template đặc tả use case}
    \label{tab:template_uc}
\end{table}
...
\begin{table}[H]
    \centering
    \begin{tabular}{|c|p{2.2cm}|p{3cm}|c|p{2.2cm}|p{2.1cm}|}
        \hline
    ...
    \end{tabular}
    \caption{Template dữ liệu đầu vào}
    \label{tab:template_input}
\end{table}
...
\begin{table}[H]
    ...
    \end{tabular}
    \caption{Đặc tả Use Case Đăng ký nhà hàng}
    \label{tab:uc_007}
\end{table}
...
\begin{table}[H]
    \centering
    \begin{tabular}{|c|p{3cm}|p{4cm}|c|p{3cm}|}
        \hline
    ...
    \end{tabular}
    \caption{Dữ liệu đầu vào Đăng ký nhà hàng}
    \label{tab:input_uc_007}
\end{table}
...
\begin{table}[H]
    ...
    \end{tabular}
    \caption{Đặc tả Use Case Duyệt đăng ký nhà hàng}
    \label{tab:uc_012}
\end{table}
...
\begin{table}[H]
    ...
    \end{tabular}
    \caption{Dữ liệu đầu vào Duyệt đăng ký nhà hàng}
    \label{tab:input_uc_012}
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{|p{2.5cm}|p{1.5cm}|p{3cm}|p{5.5cm}|}
        ...
        \textbf{Hậu điều kiện} & \multicolumn{3}{p{11.5cm}|}{Thực đơn được cập nhật thành công. Thay đổi được phản ánh ngay lập tức trên giao diện khách hàng thông qua FullMenuView. Sự kiện domain được ghi lại để audit trail.} \\ \hline
    \end{tabular}
    \caption{Đặc tả Use Case Quản lý thực đơn}
    \label{tab:uc_008}
\end{table}
...
\begin{table}[H]
    ...
    \end{tabular}
    \caption{Dữ liệu đầu vào Quản lý thực đơn - Tạo món ăn}
    \label{tab:input_uc_008}
\end{table}
...
\begin{table}[H]
    ...
    \end{tabular}
    \caption{Đặc tả Use Case Tìm kiếm nhà hàng}
    \label{tab:uc_002}
\end{table}
...
\begin{table}[H]
    \centering
    \begin{tabular}{|c|p{2.5cm}|p{3.5cm}|c|p{3.5cm}|}
        \hline
        \textbf{STT} & \textbf{Trường dữ liệu} & \textbf{Mô tả} & \textbf{Bắt buộc?} & \textbf{Điều kiện hợp lệ} \\ \hline
    ...
    \end{tabular}
    \caption{Dữ liệu đầu vào Tìm kiếm nhà hàng}
    \label{tab:input_uc_002}
\end{table}
...
\begin{table}[H]
    \centering
    \begin{tabular}{|c|p{4.0cm}|p{3.0cm}|c|p{3.5cm}|}
        \hline
        \textbf{STT} & \textbf{Trường dữ liệu} & \textbf{Mô tả} & \textbf{Bắt buộc?} & \textbf{Điều kiện hợp lệ} \\ \hline
    ...
    \end{tabular}
    \caption{Dữ liệu đầu vào Đặt hàng cá nhân}
    \label{tab:input_uc_003}
\end{table}
...
\begin{table}[H]
    ...
    \end{tabular}
    \caption{Đặc tả Use Case Khởi tạo TeamCart}
    \label{tab:uc_004a}
\end{table}
...
\begin{table}[H]
    ...
    \end{tabular}
    \caption{Dữ liệu đầu vào Khởi tạo TeamCart}
    \label{tab:input_uc_004a}
\end{table}
