...
Từ bối cảnh đó, đồ án lựa chọn giải quyết bài toán đặt hàng nhóm theo hướng giảm ``ma sát'' trong phối hợp và thanh toán, đồng thời vẫn đảm bảo đầy đủ hành trình đặt món của người dùng và khả năng vận hành của phía nhà hàng. Trọng tâm của dự án là tính năng \gls{teamcart} (Giỏ hàng nhóm), cho phép nhiều người cùng tham gia chọn món trong một giỏ hàng, theo dõi trạng thái cập nhật tức thời, và hỗ trợ cơ chế thanh toán theo từng thành viên theo định hướng tách bạch trách nhiệm chi trả.
