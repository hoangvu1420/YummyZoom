...
Để giải quyết các vấn đề đã xác định, đặc biệt là bài toán TeamCart với yêu cầu đồng bộ tức thì và thanh toán phân tán, dự án YummyZoom lựa chọn hướng tiếp cận tập trung vào kiến trúc phân lớp rõ ràng và trải nghiệm người dùng đa nền tảng tối ưu.

Về mặt kiến trúc, đồ án áp dụng Clean Architecture kết hợp chặt chẽ với Domain-Driven Design (DDD). Đây là nền tảng cốt lõi giúp hệ thống kiểm soát được sự phức tạp của các quy tắc nghiệp vụ về đặt hàng và thanh toán, đồng thời dễ dàng thích ứng với các thay đổi trong tương lai. Hệ thống Backend được xây dựng trên nền tảng .NET 9 hiện đại, vừa đảm bảo hiệu năng xử lý cao, vừa tận dụng được sức mạnh của SignalR để giải quyết bài toán giao tiếp thời gian thực (Real-time) - "trái tim" của tính năng TeamCart.

Đối với trải nghiệm người dùng (Frontend), giải pháp được chia làm hai mũi nhọn chiến lược. Thứ nhất, ứng dụng dành cho khách hàng cuối được phát triển bằng Flutter. Lựa chọn này cho phép tạo ra một trải nghiệm đồng nhất, mượt mà (Native performance) trên cả iOS và Android, đồng thời dễ dàng tùy biến các hiệu ứng giao diện phức tạp khi thao tác nhóm mà không gặp rào cản về hiệu năng. Thứ hai, cổng thông tin dành cho Nhà hàng và Quản trị viên được xây dựng dưới dạng Single Page Application (SPA) sử dụng Angular và PrimeNG. Giải pháp này mang lại một môi trường làm việc chuyên nghiệp, có cấu trúc chặt chẽ và khả năng xử lý các bảng dữ liệu lớn một cách tin cậy.

Bên cạnh đó, giải pháp tổng thể còn bao gồm việc tích hợp các công nghệ hạ tầng tiên tiến như PostgreSQL cho lưu trữ dữ liệu bền vững, Redis cho bộ nhớ đệm tốc độ cao, và các dịch vụ đám mây chuyên biệt (Stripe cho thanh toán, Cloudinary cho hình ảnh). Đóng góp chính của đồ án không chỉ dừng lại ở việc xây dựng một ứng dụng giao đồ ăn hoàn chỉnh, mà còn là việc minh chứng cho khả năng áp dụng các kiến trúc phần mềm phức tạp vào thực tế để giải quyết triệt để vấn đề "nỗi đau" thanh toán nhóm của người dùng.

\section{Bố cục đồ án (Sửa sau)}
\label{section:1.4}
