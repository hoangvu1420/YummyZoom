...
\begin{longtable}{|p{2.5cm}|p{1.5cm}|p{3cm}|p{5.5cm}|}
    ...
    \textbf{Tiền điều kiện} & \multicolumn{3}{p{11.5cm}|}{TeamCart đang hoạt động (Active) và có món ăn. Host đã đăng nhập. Để thanh toán, giỏ phải được khóa và đang ở trạng thái Finalized. Để đặt hàng, giỏ phải ở trạng thái ReadyToConfirm.} \\ \hline
    \endfirsthead
    ...
    \multirow{10}{2.5cm}{\textbf{Luồng sự kiện chính}} & \textbf{STT} & \textbf{Thực hiện bởi} & \textbf{Hành động} \\ \cline{2-4} 
     ...
     & 6 & Thành viên & Chọn phương thức thanh toán (Online hoặc COD) và thanh toán/commit phần của mình. \\ \cline{2-4} 
     & 7 & Hệ thống & Ghi nhận thanh toán; nếu chưa đủ thì chờ các thành viên khác. Khi đủ, chuyển trạng thái TeamCart sang "ReadyToConfirm" và kích hoạt nút "Đặt hàng" cho Host. \\ \cline{2-4} 
     ...
     & 10 & Hệ thống & Chốt hạn mức Coupon (nếu có), tạo Order và chuyển trạng thái TeamCart sang "Converted". Thông báo đặt hàng thành công cho tất cả thành viên. \\ \hline
    \multirow{5}{2.5cm}{\textbf{Luồng sự kiện thay thế}} & \textbf{STT} & \textbf{Thực hiện bởi} & \textbf{Hành động} \\ \cline{2-4} 
     & 4a & Hệ thống & Từ chối chốt giá nếu TeamCart không ở trạng thái Locked (CannotFinalizePricingInCurrentStatus). \\ \cline{2-4} 
     & 6a & Hệ thống & Từ chối thanh toán nếu TeamCart chưa ở trạng thái Finalized (CanOnlyPayOnFinalizedCart). \\ \cline{2-4} 
    ...
    \textbf{Hậu điều kiện} & \multicolumn{3}{p{11.5cm}|}{Đơn hàng được tạo thành công trên hệ thống. TeamCart hoàn tất vòng đời và được chuyển đổi thành một đơn hàng bình thường, Host có thể theo dõi đơn hàng này.} \\ \hline
\end{longtable}
...
\begin{longtable}{|c|p{3cm}|p{4cm}|c|p{3cm}|}
    ...
    \caption{Dữ liệu đầu vào Chốt giá TeamCart} \label{tab:input_uc_004c_finalize} \\
    \endlastfoot
