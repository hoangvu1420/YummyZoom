...
Hình \ref{fig:activity_order_processing_1} và Hình \ref{fig:activity_order_processing_2} dưới đây mô tả chi tiết các bước trong quy trình xử lý đặt hàng, từ lúc tiếp nhận yêu cầu, xác thực, tính toán tài chính cho đến khi hoàn tất đơn hàng.
...
\begin{figure}[!b]
    \centering
    \includegraphics[width=\textwidth, height=0.85\textheight, keepaspectratio]{../Hinhve/activity_order_processing(1).png}
    \caption{Biểu đồ hoạt động - Quy trình xử lý đặt hàng (1)}
    \label{fig:activity_order_processing_1}
\end{figure}
\clearpage

\begin{figure}[!t]
    \centering
    \includegraphics[width=\textwidth, height=0.85\textheight, keepaspectratio]{../Hinhve/activity_order_processing(2).png}
    \caption{Biểu đồ hoạt động - Quy trình xử lý đặt hàng (2)}
    \label{fig:activity_order_processing_2}
\end{figure}
\clearpage

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth, height=\textheight, keepaspectratio]{../Hinhve/activity_teamcart_process.png}
