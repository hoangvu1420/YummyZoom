...
{\textbf{\Large{Thiết kế xây dựng hệ thống giao đồ ăn YummyZoom}}\\[1cm]

{\textbf{\large{HOÀNG NGUYÊN VŨ}}}\\
{\large{vu.hn215171@sis.hust.edu.vn}}\\[0.5cm]
...
\resizebox{\textwidth}{!}{%
\begin{tabular}{ll}
\multicolumn{1}{c}{\textbf{Giảng viên hướng dẫn:}} & ThS. Đỗ Tuấn Anh \hspace{0.5cm} \underline{\hspace{3cm}}  \\[0.5cm]
